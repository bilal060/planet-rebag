    ...
    <>
      ...
      <div className="login-container">
        <div className="login-sub text-center flex-column">
          ...
          <div className="auth-responsive w-100">
            <h3 className="font-32 big-text-color">Sign Up</h3>
                ...
                <div className="form-group mt-2">
                  ...
                  <div className="input-group mt-2">
                    <input
                      ...
                      className="form-control password-input emailInput"
                      id="passwordInput"
                      value={password}
